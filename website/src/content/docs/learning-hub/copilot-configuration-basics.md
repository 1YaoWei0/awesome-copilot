...
**Grouped model list** *(v1.0.79+)*: The picker now organizes models into **Recent**, **Recommended**, **New**, and other sections instead of a single flat list, making it faster to find the model you used last or spot newly available options. Press **Shift+Tab** to cycle between grouping views.
