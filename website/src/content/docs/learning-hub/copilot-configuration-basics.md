...
**Grouped model picker** *(v1.0.79+)*: The model picker now groups available models into **Recent**, **Recommended**, **New**, and other sections instead of showing a flat list. Press **Shift+Tab** to switch between grouping views, making it faster to find a model you've used recently or discover newly added ones.
