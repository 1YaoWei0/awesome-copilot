...
> 💡 Agents are covered in [Chapter 04](../04-agents-and-custom-instructions/). Skills are covered in detail in [Chapter 05](../05-skills/). MCP servers are covered in [Chapter 06](../06-mcp-servers/).
